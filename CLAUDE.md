...
- **Şablon dizesi (`` ` ``) içindeki yoruma ters tırnak koyma.** Tezgâhı kesip `SyntaxError: missing ) after argument list` verir; hata satırı da yanıltıcı yeri gösterir. Bu gece iki kez oldu (tests/81, tests/86).
